...
Ext.define('Ext.ux.InputTextMask', {
   constructor: function(mask, clearWhenInvalid) {
      this.clearWhenInvalid = clearWhenInvalid === undefined ? true : clearWhenInvalid;
      this.rawMask = mask;
      return this;
   },
   ...
   init: function(field) {
      this.field = field;
      this.field.inputTextMask = this;
      this.parseMask(this.rawMask);
   ...
   removeValueWhenInvalid: function() {
      ...
      this.field.fireEvent('afterBlur', this.field);
   },
   ...
   moveCursorToPosition: function(keycode, cursorPosition) {
      ...
      this.field.fireEvent('afterMoveCursorToPosition', this, this.field);
   },
